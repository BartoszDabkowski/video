  ...
  <section class="mb-8 py-20 text-white text-center relative">
    ...
    <div class="container mx-auto">
      <div class="text-white main-header-content">
        <h1 class="font-bold text-5xl mb-5">Watch Great Videos!</h1>
    ...
    <img
      ...
      src="assets/img/introduction-video.png"
    />
  </section>
  ...
  <section class="container mx-auto">
    <div class="bg-white rounded border border-gray-200 relative flex flex-col">
      ...
      <ol id="playlist">
        ...
        >
          <div>
            <a href="#" class="font-bold block text-gray-600">Video Title</a>
  ...
  >
    <div class="relative">
      ...
      <div class="float-left w-7 h-7 leading-3 ml-7 mt-2 player-scrub">
        <div
          class="absolute left-0 right-0 text-lg text-center mx-auto player-video-info"
        >
          <span class="video-title">Video Title</span> by
